...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    departure_airport_code = "BLR" # str | Departure Airport code following [IATA standard](http://www.iata.org/publications/Pages/code-search.aspx)
max = 3.14 # int, float | Maximum number of destination in the response. (optional)

    try:
        # get airport direct routes
        api_response = api_instance.airport__direct_destinations(departure_airport_codemax=max)
        pprint(api_response)
...
------------ | ------------- | ------------- | -------------
*DirectDestinationsApi* | [**airport__direct_destinations**](docs/apis/tags/DirectDestinationsApi.md#airport__direct_destinations) | **get** /airport/direct-destinations | get airport direct routes
...
## Documentation For Models
 ...
 - [Warnings](docs/models/Warnings.md)
